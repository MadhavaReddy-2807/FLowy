...
<div className="flex justify-center my-auto ">{isSignedIn?<Button onClick={()=>{godash()}}>Get Started <ArrowRight/></Button>:<Button onClick={()=>{godash()}}>Login <ArrowRight/></Button>}</div>
</div>
    </div>
  );
}
